...
return [
    ...
    'To change the value of one property (e.g. modality), you need to provide all of its former properties that you want to keep, otherwise this information will be lost.' => 'Pour changer la valeur d\'une propriété (ex : modalité), vous devez renseigner toutes les propriété de l\'objet scientifique. Sinon, les propriétés vides seront considérés comme des valeurs à supprimer et de l\'information sera perdue.',
    'It is not possible to change the experiment.' => 'Il n\'est pas possible de changer l\'expérimentation d\'un objet scientifique',
    'To assign scientific objects to two experiments, you need to first create the scientific objects in one of the experiments. Secondly, update the scientific objects with the uri of the second experiment in the "experiment" column and their metadata in the second experiment (e.g. give the new alias and repeat the experimental modality values if they are the same).' => 'Pour assigner un objet scientifique à deux expérimentations, vous devez commencer par créer l\'objet scientifique dans une expérimentation. Mettez ensuite à jour l\'objet scientifique en renseignant l\'uri de la seconde expérimentation dans la colonne "expérimentation", en n\'oubliant pas de renseigner les métadonnées de l\'objet. Par exemple, renseignez le nouvel alias de l\'objet scientifique dans le contexte de la seconde expérimentation et répéter la valeur de la colonne modalité expérimentale qui ne change pas',
