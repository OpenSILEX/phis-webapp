...
// Subject: Corresponds to the projects service - extends WSModel
//***********************************************************************************************
 ...
 */
class WSProjectModel extends \openSILEX\guzzleClientPHP\WSModel{
    
    /**
     * initialize access to the projects service. Calls super constructor
     */
    public function __construct() {
        parent::__construct(WS_PHIS_PATH, "projects");
    }
    
    /**
     * 
     * @param String $sessionToken connection user token
     * @param String $uri uri of the searched project
     ...
     * ]
     * @return mixed if the project exist, an array representing the project 
     *               else the error message 
     */
    public function getProjectByURI($sessionToken, $uri, $params) {
