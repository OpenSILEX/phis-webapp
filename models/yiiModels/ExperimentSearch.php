...
// Subject: ExperimentSearch represents the model behind the search form about app\models\Experiment 
...
/**
 * implements the search action for the experiments
 *
 * @author Morgane Vidal <morgane.vidal@inra.fr>
 */
class ExperimentSearch extends YiiExperimentModel {
    //SILEX:refactor
    ...
    {
        return [
            [['uri', 'startDate', 'endDate', 'field', 'campaign', 'place', 'geographicLocation', 'alias', 'comment', 'keywords', 'objective'], 'safe'],
        ];
    }
