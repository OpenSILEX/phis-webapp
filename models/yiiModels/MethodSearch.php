...
// Subject: VariableSearch represents the model behind the search form about app\models\yiiModels\YiiMethodModel
...
/**
 * implements the search action for the methods
 *
 * @author Morgane Vidal <morgane.vidal@inra.fr>
 */
class MethodSearch extends YiiMethodModel {
    //SILEX:refactor
