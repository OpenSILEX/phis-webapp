...
// Subject: VariableSearch represents the model behind the search form about app\models\yiiModels\YiiVariableModel
...
/**
 * implements the search action for the variables
 *
 * @author Morgane Vidal <morgane.vidal@inra.fr>
 */
class VariableSearch extends YiiVariableModel {
    //SILEX:refactor
    ...
    public function rules() {
        return [
          [['uri', 'label', 'trait', 'method', 'unit'], 'safe']  
        ];
    }
